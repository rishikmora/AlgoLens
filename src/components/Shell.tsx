...
import { Flame, Search, Zap, Coins, Sun, Moon, ArrowRight } from "lucide-react";
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2">
          ...
          {mounted && (
            <Link
              ...
              className="flex items-center gap-2.5 rounded-sm border border-edge bg-raised px-2 py-1 font-mono text-2xs tabular-nums text-secondary transition-colors hover:border-edge-strong hover:text-primary"
            >
